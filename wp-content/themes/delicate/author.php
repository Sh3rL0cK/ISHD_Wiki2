...
<?php rewind_posts(); ?>
     ...
     <?php while (have_posts()) : the_post(); ?>										
			<div class="post">            	
                ...
                <small><?php the_time('F jS, Y') ?> | <?php _e('Posted by','nattywp'); ?> <span class="author"><?php the_author() ?></span> <?php _e('in','nattywp'); ?> <?php the_category(' | ');?> - (<?php comments_popup_link(__('0 Comments', 'nattywp'), __('1 Comments', 'nattywp'), __('% Comments', 'nattywp')); ?>)</small> 
                </div>              
				<div class="entry">
          <?php
