	...
	<div class="columns">      
     ...
     <?php while (have_posts()) : the_post(); ?>							
			<div <?php post_class();?>>
                ...
                <!-- <small><?php _e('Posted by','nattywp'); ?> <span class="author"><?php natty_get_profile() ?></span> <?php _e('in','nattywp'); ?> <?php the_category(' | ');?> - (<?php comments_popup_link(__('0 Comments', 'nattywp'), __('1 Comments', 'nattywp'), __('% Comments', 'nattywp')); ?>)</small>-->
                </div>                
				<!-- <div class="entry">				
